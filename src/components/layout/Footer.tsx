  ...
  return (
    <footer className="bg-theme-surface border-t border-theme pt-16 pb-8 transition-colors duration-300">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-theme pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-theme-muted">
           <p>© 2026 Freshcart E-commerce Template. All rights reserved.</p>
           <div className="flex space-x-2 mt-4 md:mt-0">
             <span className="bg-theme-surface-2 px-2 py-1 rounded">Visa</span>
             <span className="bg-theme-surface-2 px-2 py-1 rounded">Mastercard</span>
             <span className="bg-theme-surface-2 px-2 py-1 rounded">Paypal</span>
           </div>
        </div>
      </div>
    </footer>
